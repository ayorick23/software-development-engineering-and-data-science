---
Fecha de creación: 2026-07-10T18:28:00
Materia:
  - Programación Web II (Frontend)
Fecha de clase: 2026-07-10
---
...
Una **aplicación web** es un software que se ejecuta en un servidor y al que los usuarios acceden mediante un navegador web.
...
### ¿Qué podemos desarrollar con ASP.NET Core?

Con ASP.NET Core podemos crear:
...
Es una implementación del patrón MVC en ASP.NET Core. Divide la aplicación en tres componentes principales: Modelo (datos y lógica de negocio), Vista (presentación y UI) y Controlador (maneja las solicitudes y coordina el flujo de datos).
...
MVC permite que un proyecto pueda crecer sin perder organización.

### ¿ASP.NET Core con C#?

El lenguaje de programación principal utilizado con ASP.NET es C#. Es un lenguaje orientado a objetos desarrollado por Microsoft que se integra estrechamente con el entorno .NET.
