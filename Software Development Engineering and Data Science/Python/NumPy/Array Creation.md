...
**NumPy** es una biblioteca de [[Introduction#Introduction to Python|Python]] fundamental para la computación científica y el análisis de datos. Su principal función es proporcionar objetos de matriz multidimensionales (*llamados [[Clase 04 - Listas, Arreglos, Matrices y Estructuras Condicionales#Arreglos (`Array`)|ndarray]]*) que permiten almacenar y manipular grandes conjuntos de datos de manera eficiente, así como una amplia gama de funciones matemáticas para operar sobre estas matrices.
