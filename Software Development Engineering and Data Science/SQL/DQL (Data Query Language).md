...
Se usa para agrupar filas que tienen los mismos valores en una o más columnas en un conjunto de filas de resumen. Es crucial cuando se utilizan [[SQL/Aggregate Functions|funciones de agregación]] (`COUNT`, `SUM`, `AVG`, `MIN`, `MAX`).
